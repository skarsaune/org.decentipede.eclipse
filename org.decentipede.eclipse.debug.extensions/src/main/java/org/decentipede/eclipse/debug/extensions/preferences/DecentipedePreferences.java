...
public class DecentipedePreferences
	extends FieldEditorPreferencePage
	implements IWorkbenchPreferencePage {

	public DecentipedePreferences() {
		super(GRID);
		setPreferenceStore(DecentipedePlugin.getDefault().getPreferenceStore());
		setDescription("Preferences for Decentipede debug extensions");
	}
